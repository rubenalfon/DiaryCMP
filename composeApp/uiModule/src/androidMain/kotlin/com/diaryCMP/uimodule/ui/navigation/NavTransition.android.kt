...
private val di =
    slideInHorizontally(initialOffsetX = { it }) + fadeIn(animationSpec = tween(easing = LinearOutSlowInEasing))
private val ai =
    slideOutHorizontally(targetOffsetX = { it }) + fadeOut(animationSpec = tween(easing = LinearOutSlowInEasing))
private val dp =
    slideOutHorizontally(targetOffsetX = { -it / 2 }) + fadeOut(animationSpec = tween(easing = LinearOutSlowInEasing))
private val ap =
    slideInHorizontally(initialOffsetX = { -it / 2 }) + fadeIn(animationSpec = tween(easing = LinearOutSlowInEasing))
